...
'consistent-heading-style' satisfies RuleName;
...
'md/consistent-heading-style' satisfies AllConfigRuleName;
...
'md/consistent-heading-style' satisfies StylisticConfigRuleName;
