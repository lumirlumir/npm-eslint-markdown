...
You can find the full list of [language identifiers shorthand mapping](https://github.com/lumir/npm-eslint-markdown/blob/main/packages/eslint-markdown/src/rules/code-lang-shorthand.js) in the source code.
